/* Your Code Here */
function createEmployeeRecord(myEmployee) {
    return {
      firstName: myEmployee[0],
      familyName: myEmployee[1],
      title: myEmployee[2],
      payPerHour: myEmployee[3],
      timeInEvents: [],
      timeOutEvents: [],
    };
...
function findEmployeeByFirstName(employeeCollection, name) {
    return employeeCollection.find(employee=> employee.firstName===name)
}
